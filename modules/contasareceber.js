...
try{
  ...
  async function confirmarReceber(){
    ...
    try{
      ...
      recs.push({ id: crypto.randomUUID(), data: data, forma_pagamento: forma, canal_baixa: titulo.settlement_mode || "manual", valor_centavos: cents, obs: obs, created_at: new Date().toISOString() });
