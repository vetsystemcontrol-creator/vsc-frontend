...
.kado-hdr-top{display:grid;grid-template-columns:minmax(0,1fr) 170px;column-gap:22px;align-items:start;}
.kado-system-wrap{display:flex;align-items:flex-start;justify-content:flex-start;min-height:132px;}
.kado-system-logo{width:468px;max-width:100%;height:auto;display:block;margin:0;border:none !important;border-radius:0 !important;object-fit:contain;object-position:left top;image-rendering:auto;}
.kado-fallback-system{font-size:30px;font-weight:900;line-height:1.05;color:#0f172a;}
.kado-company-logo-wrap{display:flex;justify-content:flex-end;align-items:flex-start;justify-self:end;width:170px;min-height:132px;}
.kado-company-logo{width:154px;max-width:154px;height:154px;object-fit:contain;object-position:center top;display:block;margin:0;border:none !important;border-radius:0 !important;image-rendering:auto;}
...
.kado-hdr-bottom{display:grid;grid-template-columns:minmax(0,1fr) 440px;column-gap:22px;row-gap:0;align-items:start;margin-top:4px;}
...
.kado-doc-meta{display:grid;gap:9px;font-size:12px;line-height:1.45;color:#334155;}
    ...
    return `
      <div class="kado-hdr">
        <div class="kado-hdr-top">
          <div class="kado-system-wrap">${safe(data.systemLogoHtml || data.systemLogoFallback)}</div>
