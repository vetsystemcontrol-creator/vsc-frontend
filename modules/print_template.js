...
.kado-hdr-grid{display:grid;grid-template-columns:minmax(0,1fr) 430px;grid-template-areas:"system badge" "company doc";column-gap:18px;row-gap:6px;align-items:start;}
...
.kado-company-logo-wrap{grid-area:badge;display:flex;justify-content:flex-end;align-items:flex-start;min-height:150px;}
