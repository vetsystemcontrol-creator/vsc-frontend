(()=>{
  ...
  function getInstitutionalCss(){
    return `
.kado-hdr{border:1px solid #cfd9e5;border-radius:20px;padding:16px 16px 0;background:#fff;overflow:hidden;margin-bottom:12px;}
.kado-hdr::after{content:"";display:block;height:9px;border-radius:0 0 18px 18px;margin:10px -16px 0;background:linear-gradient(90deg,#1ea35a 0%, #14b8a6 56%, #1d9bf0 100%);}
.kado-hdr-top{display:grid;grid-template-columns:minmax(0,1fr) 180px;column-gap:18px;align-items:start;}
.kado-system-wrap{display:flex;align-items:flex-start;justify-content:flex-start;min-height:156px;}
.kado-system-asset{position:relative;width:430px;max-width:100%;min-height:148px;}
.kado-system-logo{width:100%;max-width:100%;height:auto;display:block;margin:0;border:none !important;border-radius:0 !important;object-fit:contain;object-position:left top;image-rendering:auto;}
.kado-system-logo-fallback{display:none;position:absolute;inset:0;align-items:flex-start;justify-content:flex-start;font-size:30px;font-weight:900;line-height:1.05;color:#0f172a;}
.kado-company-logo-wrap{display:flex;justify-content:flex-end;align-items:flex-start;justify-self:end;width:180px;min-height:156px;}
.kado-company-logo{width:156px;max-width:156px;height:156px;object-fit:contain;object-position:center top;display:block;margin:0;border:none !important;border-radius:0 !important;image-rendering:auto;}
...
.kado-hdr-bottom{display:grid;grid-template-columns:minmax(0,1fr) 1fr;column-gap:42px;row-gap:0;align-items:start;margin-top:6px;}
.kado-company-box{display:grid;gap:6px;align-content:start;padding-top:0;}
.kado-company-name{font-size:28px;line-height:1.02;font-weight:900;letter-spacing:-.03em;margin:0;color:#0f172a;text-transform:uppercase;}
.kado-company-meta{font-size:12px;line-height:1.42;color:#334155;display:grid;gap:2px;}
.kado-doc-box{align-self:start;padding-top:2px;}
      ...
      <div class="kado-hdr">
        <div class="kado-hdr-top">
          <div class="kado-system-wrap">
            <div class="kado-system-asset">
              <img class="kado-system-logo" src="${safe(data.systemLogoSrc)}" alt="Vet System Control" onerror="this.style.display='none';this.nextElementSibling.style.display='flex';" />
              <div class="kado-system-logo-fallback">${safe(data.systemLogoFallback)}</div>
            </div>
          </div>
