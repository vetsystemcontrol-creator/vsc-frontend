(function(){
  ...
  function fillDefaultsForNewDoc(){
  ...
  function currentDocSnapshot(){
    ...
    return normalizeDoc(Object.assign({}, base, form, {
      id: currentId || (existing && existing.id) || crypto.randomUUID(),
      model: 55,
...
<body>
  ...
  function bind(){
    ...
    $("btnAddItem").addEventListener("click", () => {
      currentItems.push(normalizeItem({ id: crypto.randomUUID(), unidade:"UN", quantidade:1 }));
      renderItems();
    });
